...
-- DML: IEEE 754 special values (NaN, Infinity)
...
-- DML: IEEE 754 edge cases (negative zero, denormalized, min/max normal)
...
INSERT INTO TEST_NUMBERS VALUES (12,
    0, 0, 0, 0, 0,
    UTL_RAW.CAST_TO_BINARY_FLOAT('00000001'),
    UTL_RAW.CAST_TO_BINARY_DOUBLE('0000000000000001')
);
INSERT INTO TEST_NUMBERS VALUES (13,
    0, 0, 0, 0, 0,
    UTL_RAW.CAST_TO_BINARY_FLOAT('00800000'),
    UTL_RAW.CAST_TO_BINARY_DOUBLE('0010000000000000')
);
INSERT INTO TEST_NUMBERS VALUES (14,
    0, 0, 0, 0, 0,
    UTL_RAW.CAST_TO_BINARY_FLOAT('7F7FFFFF'),
    UTL_RAW.CAST_TO_BINARY_DOUBLE('7FEFFFFFFFFFFFFF')
);
COMMIT;
